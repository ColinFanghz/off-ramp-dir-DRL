...
def get_args():
    ...
    # parser.add_argument("--Acc", type=float, default=None, help="Store the acceleration of ego vehicle in last step.")
    # parser.add_argument("--heading", type=float, default=None, help="Store the heading of ego vehicle in last step.")
...
if __name__ == '__main__':
    ...
    np.save("model_results/sac_123_results.npy", arr=np.array(model_results))
